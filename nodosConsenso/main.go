...
func (n *NodoConsenso) obtenerPuertoPorID(id string) string {
	switch id {
	case "ATC1": return "50061"
	case "ATC2": return "50062"
	case "ATC3": return "50063"
	default: return "50061"
	}
}

func (n *NodoConsenso) RegistrarEntidad(ctx context.Context, req *pb.RegistroRequest) (*pb.RegistroResponse, error) {
	return &pb.RegistroResponse{Exito: true, Mensaje: "OK"}, nil
}

func (n *NodoConsenso) SolicitarInicio(ctx context.Context, req *pb.InicioRequest) (*pb.InicioResponse, error) {
	return &pb.InicioResponse{PuedeIniciar: true, Mensaje: "Consenso listo"}, nil
}
...
func main() {
	...
	var puerto string
	switch *nodoPtr {
	case "ATC1": puerto = "50061"
	case "ATC2": puerto = "50062" 
	case "ATC3": puerto = "50063"
	default: puerto = "50061"
	}
